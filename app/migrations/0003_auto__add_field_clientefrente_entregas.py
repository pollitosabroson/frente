...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteFrente.entregas'
        db.add_column(u'app_clientefrente', 'entregas',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteFrente.entregas'
        db.delete_column(u'app_clientefrente', 'entregas')
